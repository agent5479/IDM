  ...
  <div id="accessories" style="scroll-margin-top: 90px; margin-bottom: 50px;">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 24px;">
      <div class="catalog-sku-card">
        ...
        <p style="color: #ffa500; font-size: 0.85rem; font-weight: 700; letter-spacing: 0.04em; text-transform: uppercase; margin-bottom: 8px;">Available to order</p>
        <h3 style="color: #ffa500; margin-bottom: 12px;">Riser Box</h3>
        <p style="color: #ccc; line-height: 1.8; margin-bottom: 16px;">Raises the screener for more material under the deck and steadies the unit. Winches and 2-inch straps — on or off in under five minutes. Available for 68 / 78 / 108 class machines.</p>
        <p style="color: #888; font-size: 0.95rem; font-style: italic;">Available to order for next shipment</p>
      </div>
      <div class="catalog-sku-card">
        <div class="catalog-sku-media">
        ...
        <p style="color: #ffa500; font-size: 0.85rem; font-weight: 700; letter-spacing: 0.04em; text-transform: uppercase; margin-bottom: 8px;">Available to order</p>
        <h3 style="color: #ffa500; margin-bottom: 12px;">Bucket Transport Lugs</h3>
        <p style="color: #ccc; line-height: 1.8; margin-bottom: 16px;">Move the screener around the job with the carrier bucket — no wheels, axle or hitch. Optional on Proscreen and Static Grizzly models.</p>
        <p style="color: #888; font-size: 0.95rem; font-style: italic;">Available to order for next shipment</p>
      </div>
    </div>
  </div>
