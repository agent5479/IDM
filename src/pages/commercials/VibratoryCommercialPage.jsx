...
const phrases = {
  hook: [
    ...
    'Screen, grade and reuse where you stand. Unique DeSite vibratory action, NZ supply and support from Site Machinery.',
    'From compact 68V to heavy 108VFRB — quiet, low-maintenance vibratory screening built for New Zealand contractors.',
  ],
  tagline: [
  ...
  unique: [
    'The vibratory screening system on Proscreens is unique to DeSite — and supplied in New Zealand exclusively through Site Machinery.',
  ...
  cta: [
    'Match model to bucket and material, then contact Site Machinery for pricing and Nelson showroom viewing.',
    'See the range, check the mesh guide, call for a setup that fits your carrier.',
    'Ready for vibratory Proscreen numbers? Talk to us — nationwide supply from Nelson.',
  ],
}
